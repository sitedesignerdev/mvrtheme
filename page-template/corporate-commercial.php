...
/*Template Name: Corporate Commercial Page
*/
get_header(); 
?>
...
<section class="relative py-20 bg-primary text-white">
    ...
    <div class="absolute inset-0 z-0">
        <div class="absolute inset-0 bg-black opacity-50"></div>
            <img 
                src="<?php echo get_template_directory_uri(); ?>/src/images/service_bg_two.jpg" 
    ...
    <div class="relative container mx-auto px-12 z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-serif font-bold mb-6">Corporate Commercial</h1>
