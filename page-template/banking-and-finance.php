...
/*Template Name: Banking and Finance Page
*/
...
<section class="relative py-20 bg-primary text-white">
    ...
    <div class="relative container mx-auto px-12 z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-serif font-bold mb-6">Banking and Finance</h1>
            ...
            <div>
                ...
                <div class="prose prose-lg max-w-none">
                    <p class="text-gray-700 mb-6">
                        The Banking & Finance department is led by <strong>Eduan Kapp</strong> who has thirty years of finance experience. In addition to his legal experience, he has worked as an investment banker in London and was a founding partner in two Sub- Saharan funds, both based in Mauritius. In the past 30 months, he developed a team responsible for advising clients on deals worth approximately R38bn.
                    </p>
                    <p class="text-gray-700 mb-6">
                       He has acted for sovereigns, multi nationals, investment banks, finance and PE companies and has been actively involved – from origination, advisory, structuring, implementing to exit – in more than 150 major transactions in emerging markets.
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <ul class="space-y-3">
                        <li class="flex items-center">
                            ...
                            Acquisition and disposal finance
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-accent mr-3" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                    ...
                    <ul class="space-y-3">
                        ...
                        <li class="flex items-center">
                            ...
                            High-yield hybrid instruments
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-accent mr-3" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                            Corporate and capital restructure;
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-accent mr-3" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    ...
                    > -->
                    <p class="text-sm font-semibold text-gray-800">Transnet SOC Limited</p>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    <!-- <img 
                        ...
                        onerror="this.src='<?php echo get_template_directory_uri(); ?>/assets/images/clients/placeholder-logo.png'"
                    > -->
                    <p class="text-sm font-semibold text-gray-800">ArcelorMittal South Africa</p>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    <!-- <img 
                        ...
                        onerror="this.src='<?php echo get_template_directory_uri(); ?>/assets/images/clients/placeholder-logo.png'"
                    > -->
                    <p class="text-sm font-semibold text-gray-800">Cennergi</p>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    <!-- <img 
                        ...
                        onerror="this.src='<?php echo get_template_directory_uri(); ?>/assets/images/clients/placeholder-logo.png'"
                    > -->
                    <p class="text-sm font-semibold text-gray-800">Rand Merchant Bank</p>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    <!-- <img 
                        ...
                        onerror="this.src='<?php echo get_template_directory_uri(); ?>/assets/images/clients/placeholder-logo.png'"
                    > -->
                    <p class="text-sm font-semibold text-gray-800">DBSA</p>
                </div>
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    <!-- <img 
                        ...
                        onerror="this.src='<?php echo get_template_directory_uri(); ?>/assets/images/clients/placeholder-logo.png'"
                    > -->
                    <p class="text-sm font-semibold text-gray-800">Magni Investments Holdings</p>
                </div>
