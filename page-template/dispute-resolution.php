...
/*Template Name: Dispute Resolution Page
*/
...
<section class="relative py-20 bg-primary text-white">
    ...
    <div class="relative container mx-auto px-4 z-10">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-serif font-bold mb-6">Dispute Resolution</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
                ...
                <div class="prose prose-lg max-w-none">
                    ...
                    <p class="text-gray-700 mb-6">
                        She has recently acted for prominent public and private sector entities in litigation and dispute resolution matters, such as Labat Africa Limited, ArcelorMittal South Africa Limited, Imperial Logistics Group of Companies, Mobile Technology Network (Pty) Limited (MTN), Vodacom SA (Pty) Limited, Public Investment Corporation SOC Limited (PIC), Rand Mutual Assurance Company Limited (RMA), and African Bank Limited.
                    </p>
                </div>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="bg-white rounded-lg p-6 text-center shadow-sm hover:shadow-md transition duration-300 flex flex-col items-center justify-center h-32">
                    ...
                    > -->
                    <p class="text-sm font-semibold text-gray-800">Imperial Logistics Group of Companies</p>
                </div>
